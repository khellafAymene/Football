...
Title_left = "Best Performance"              # العنوان الأيسر (أصبح الأفضل على اليسار)
...
Title_right = "Worst Performance"            # العنوان الرئيسي (أصبح الأسوأ على اليمين)
...
if SHOW_SEPARATOR:
    ...
    for row_idx in range(n_metrics - 1):
        ...
        ax.plot([separator_x_end, x_end], [y_mid + 0.05, y_mid + 0.05],
...
fig.subplots_adjust(top=1, bottom=0.0, left=0.36, right=1)
plt.show()